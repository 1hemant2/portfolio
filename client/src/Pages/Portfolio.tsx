    ...
    const projects = [
        {
            ...
            title: 'GHOST CHAT',
            tech: 'MERN STACK',
            description: 'social media platform facilitating seamless post sharing and user interaction. Integrated features such as uploading posts, liking, disliking, commenting, following, and messaging. Incorporated a notification system for user updates and ensured a consistent experience across devices through responsive design.',
        ...
        },
        {
            ...
            tech: 'MERN STACK',
            description: 'Platform focused on delivering free content material with an emphasis on user experience. Established administrative controls for effective post management, leading the project from concept to completion with a robust, user-friendly outcome.',
        ...
        },
        {
            ...
            tech: 'React.js',
            description: 'It is a  website where people can list there property and vister and go see it virtually.',
        ...
        },
        {
            ...
            tech: 'PERN Stack',
            description: 'The Hospital Management Portal is a web-based application that facilitates communication and interaction between doctors and patients. It provides a platform for doctors to manage their patients and for patients to access their assigned doctors.',
        ...
        },
        {
            ...
            tech: 'React.js',
            description: 'It is a platform where people can analyze a secotor vise price, highlight of the day, top 10 sector.',
        ...
        },
        {
            ...
            tech: 'MERN Stack',
            description: 'This is a Library management system to manage library.Admin Authentication and autharization and Add,delete,change Availabilty of Book.Search Book.See Transaction history',
            ...
            <div className="sm:grid sm:grid-cols-3 sm:gap-3 sm:ml-[200px] sm:mr-[200px] mt-14 sm:h-[550px]  overflow-y-auto scrollbar space-y-10 sm:space-y-0 pl-6 pr-6">
                {
                    projects.map((d) => (
                        <div className="relative h-[200px] group">
                            <img src={d.icon1} alt="" className="h-[200px] w-full group-hover:opacity-0 transition-opacity duration-300" />
                            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div className='font-sans text-2xl underline text-gray-600'>{d.title}</div>
                                <div className=" text-red-400 font-light">{d.tech}</div>
                                <button className="mt-6 h-[40px] w-[100px] border border-red-500 "
                                    onClick={() => handlePopup(d.description, d.link, d.icon2, d.icon3, d.icon4)}
                                >{d.buttonName}</button>
                            </div>
                        </div>
                    ))
